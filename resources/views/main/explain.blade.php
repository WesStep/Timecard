	...
	<div class="container margin-bottom">
			...
			<div class="col-md-8">
				<div class="card card-default mb-4">
					<div class="card-body">
						...
						@endif
						<h3>General Idea</h3>
						<p>Timecard.wesstep.com is a project I made in college. The original version of this app was made for a client who uses this software for his companys' employees. There are three main dashboards to login to: one for <strong>employees</strong>, one for <strong>payroll admins</strong>, and one for <strong>business owners</strong>.</p>
		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card card-default mb-4">
					<div class="card-body">
						<h1>Make sure it will work</h1>
						<p>As this is a public-facing site and the login credentials are on this page, anyone can access this app and create fictional shifts, companies, and other data. It is important that, before you go ahead and test out the app, you reset any data stored in the database first.</p>
